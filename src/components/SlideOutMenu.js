...
function SlideOutMenu(props) {
  ...
  return (
    <div
      className={`slide-out-menu ${display ? "slide-out-menu--display" : ""}`}
    >
        ...
        <div className="slide-out-menu__bottom">
          <ul className="slide-out-menu__options">
            <li className="slide-out-menu__option">
              <NavLink to="/" className="slide-out-menu__link">
                Home
              </NavLink>
            </li>
            <li className="slide-out-menu__option">
              <NavLink to="/blog" className="slide-out-menu__link">
                Blog
              </NavLink>
            </li>
            <li className="slide-out-menu__option">
              <NavLink to="/#contact" className="slide-out-menu__link">
                Contact
              </NavLink>
            </li>
            <li className="slide-out-menu__option">
